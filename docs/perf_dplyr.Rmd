...
spark_perf_test <- function(params, tests) {
  resultsList <- lapply(params, function(param) {
    ...
    optimizeShuffleForCores <- getOption("rspark.dplyr.optimizeShuffleForCores", NULL)
    options(rspark.dplyr.optimizeShuffleForCores = param$optimizeShuffleForCores)
    on.exit(options(rspark.dplyr.optimizeShuffleForCores = optimizeShuffleForCores))
      ...
      spark_perf_test(
        params = list(
          list(
            ...
            optimizeShuffleForCores = optimizeShuffleForCores
          )
        ),
        tests = list(
...
runResults <- spark_perf_single_test(runResults, "local", NULL, "1.6.0", "INFO", FALSE, 0, NULL)
runResults <- spark_perf_single_test(runResults, "local", NULL, "1.6.0", "INFO", TRUE, 0, NULL)
runResults <- spark_perf_single_test(runResults, "local", NULL, "2.0.0", "INFO", FALSE, 0, NULL)
runResults <- spark_perf_single_test(runResults, "local", NULL, "2.0.0", "INFO", TRUE, 0, NULL)
runResults <- spark_perf_single_test(runResults, "local", "auto", "1.6.0", "INFO", FALSE, 0, NULL)
runResults <- spark_perf_single_test(runResults, "local", "auto", "1.6.0", "WARN", FALSE, 0, NULL)
runResults <- spark_perf_single_test(runResults, "local", "auto", "1.6.0", "WARN", TRUE, 0, NULL)
runResults <- spark_perf_single_test(runResults, "local", "auto", "1.6.0", "WARN", TRUE, 8, NULL)
runResults <- spark_perf_single_test(runResults, "local", "auto", "2.0.0", "WARN", TRUE, 8, NULL)
runResults <- spark_perf_single_test(runResults, "local", "auto", "2.0.0", "WARN", TRUE, 0, NULL)
