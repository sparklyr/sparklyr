...
A connection to Spark can be customized by setting the values of certain Spark properties.  In `sparklyr`, Spark properties can be set by using the `conf` argument in the `spark_connect()` function.    
