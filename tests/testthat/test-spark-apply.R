...
test_spark_apply_group <- function(covr = FALSE) {
...
test_that("'spark_apply' works with 'group_by' with code coverage", {
  test_spark_apply_group(covr = TRUE)
})
