...
spark_config_settings <- function() {
  settings <- list(
    ...
    sparklyr.sdf_collect.persistence_level = "Persistence level to use when caching a Spark dataframe before collecting it from Spark to R (default: MEMORY_AND_DISK).",
