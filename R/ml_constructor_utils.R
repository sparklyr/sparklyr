...
ml_ancestry <- function(jobj) {
  ...
  classes <- c("feature.CountVectorizer", "feature.CountVectorizerModel",
               ...
               "classification.LinearSVC", "classification.LinearSVCModel",
               ...
               "clustering.GaussianMixture", "clustering.GaussianMixtureModel",
...
ml_constructor_dispatch <- function(jobj) {
  ...
  switch(ml_ancestry(jobj)[1],
         ...
         "clustering.GaussianMixture" = new_ml_gaussian_mixture(jobj),
         "clustering.GaussianMixtureModel" = new_ml_gaussian_mixture_model(jobj),
