...
spark_config_settings <- function() {
  settings <- list(
    ...
    sparklyr.gateway.connect.timeout = "Total seconds before giving up connecting to the sparklyr gateway after initialization.",
    ...
    sparklyr.gateway.start.timeout = "Total seconds before giving up connecting to the sparklyr gateway while initializing.",
    sparklyr.gateway.start.wait = "Total seconds to wait before retrying to contact the sparklyr gateway.",
